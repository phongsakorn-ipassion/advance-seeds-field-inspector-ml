...
For dynamic app-side model browsing/downloading, use
`docs/dynamic-model-loading-handoff.md`. The current mobile QA candidate set is
generated by `scripts/export_mobile_model_candidates.py` under
`runs/mobile-exports/`.
